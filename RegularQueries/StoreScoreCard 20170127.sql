...
update [Kalyan_Temp].[dbo].[temp_sp_ResidencePhonetransactiondata_full_20170125]    set phone=replace(phone,'Â','')  where phone like '%Â%'
update [Kalyan_Temp].[dbo].[temp_sp_ResidencePhonetransactiondata_full_20170125]    set phone=replace(phone,'Ã','')  where phone like '%Ã%'
update [Kalyan_Temp].[dbo].[temp_sp_ResidencePhonetransactiondata_full_20170125]    set phone=replace(phone,'ƒ','')  where phone like '%ƒ%'
update [Kalyan_Temp].[dbo].[temp_sp_ResidencePhonetransactiondata_full_20170125]    set phone=replace(phone,'¢','')  where phone like '%¢%'
update [Kalyan_Temp].[dbo].[temp_sp_ResidencePhonetransactiondata_full_20170125]    set phone=replace(phone,'€','')  where phone like '%€%'
update [Kalyan_Temp].[dbo].[temp_sp_ResidencePhonetransactiondata_full_20170125]    set phone=replace(phone,'š','')  where phone like '%š%'
update [Kalyan_Temp].[dbo].[temp_sp_ResidencePhonetransactiondata_full_20170125]    set phone=replace(phone,'¬','')  where phone like '%¬%'
...
update [Kalyan_Temp].[dbo].MobilePhoneCleaning_full_20170125  set Mobile=replace(Mobile,'Â',''),[Alphabets]='Y'  where Mobile like '%Â%'
update [Kalyan_Temp].[dbo].MobilePhoneCleaning_full_20170125    set Mobile=replace(Mobile,'Ã',''),[Alphabets]='Y'  where Mobile like '%Ã%'
update [Kalyan_Temp].[dbo].MobilePhoneCleaning_full_20170125    set Mobile=replace(Mobile,'ƒ',''),[Alphabets]='Y'  where Mobile like '%ƒ%'
update [Kalyan_Temp].[dbo].MobilePhoneCleaning_full_20170125    set Mobile=replace(Mobile,'¢',''),[Alphabets]='Y'  where Mobile like '%¢%'
update [Kalyan_Temp].[dbo].MobilePhoneCleaning_full_20170125    set Mobile=replace(Mobile,'€',''),[Alphabets]='Y'  where Mobile like '%€%'
update [Kalyan_Temp].[dbo].MobilePhoneCleaning_full_20170125    set Mobile=replace(Mobile,'š',''),[Alphabets]='Y'  where Mobile like '%š%'
update [Kalyan_Temp].[dbo].MobilePhoneCleaning_full_20170125    set Mobile=replace(Mobile,'¬',''),[Alphabets]='Y'  where Mobile like '%¬%'
